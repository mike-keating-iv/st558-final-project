...
# Save final model
save(rf_deployment_fit, file = "deployment_model.rda")
...
library(workflows)
library(recipes)
model_recipe <- extract_recipe(rf_deployment_fit)

# The template slot holds a tibble with the variable structure and factor levels
str(model_recipe$template)

# To see the levels for a specific variable, e.g., Education:
levels(model_recipe$template$Education)

# To see all factor levels for all variables:
lapply(model_recipe$template, levels)
